h1. Robotis CM-900 (originally for Arduino) library for Pololu L3G4200D and L3GD20 boards
...
This is a library for the "Robotis CM-900 series":http://www.robotsource.org/bs/bd.php?bt=forum_CM9DeveloperWorld that interfaces with L3G4200D and L3GD20 gyros on Pololu boards. It makes it simple to read the raw gyro data from these boards:
...
pre. CM-900                      L3G4200D/L3GD20 board
                  3.3V  ->  VIN
                   GND  ->  GND
        Digital Pin 15  ->  SCL
        Digital Pin 14  ->  SDA
